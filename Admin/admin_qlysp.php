...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="admin_addsp.php" class="btn fw-bold" style="background:linear-gradient(90deg,#FFD700 0%,#C1272D 100%); color:#fff; border-radius:20px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="admin_editsp.php?id=<?= $sp['id'] ?>" class="btn btn-warning btn-sm fw-bold me-1" style="border-radius:16px;"><i class="fa fa-edit"></i> Sửa</a>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="admin_restoresp.php?id=<?= $sp['id'] ?>" class="btn btn-success btn-sm fw-bold" style="border-radius:16px;">
